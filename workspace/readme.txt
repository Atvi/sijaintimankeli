Tekijät: Atte Räty, Tuomas Nurmi, Eetu Hyyryläinen, Matias Laitinen

Lisenssi: AGPL

Karttadata: OpenStreetMap
...
Ohjeita koodin käyttöönottoon:
   ...
   2. Tarkista settings.py ja muuta siellä tarvittavat tiedostopolut (ainakin LOGIN_URL, LOGIN_REDIRECT_URL ja TEMPLATE_DIRS)
    ...
    4. django-admin.py startproject [nimi] (kannattaa siirtyä pois Sijaintimanke       lin kansioista ennen tämän suorittamista)
...
Jos ilmenee ongelmia, joista et selviydy yksin, tai haluat muuten vain tietää, ota yhteyttä Atte Rätyyn (atte.t.raty@student.jyu.fi) (jyu irc: Atvi).
